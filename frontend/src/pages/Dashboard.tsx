      ...
      <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <div className="casino-bg-secondary backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 casino-border text-center">
            ...
            <h3 className="text-xl sm:text-2xl font-bold casino-text-primary mb-1">
              ${balance || '0.00'}
            </h3>
            <p className="text-sm sm:text-base casino-text-secondary">Fortune Panda Balance</p>
          </div>
          ...
          <div className="casino-bg-secondary backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 casino-border text-center">
            ...
            <h3 className="text-xl sm:text-2xl font-bold casino-text-primary mb-1">Active</h3>
            <p className="text-sm sm:text-base casino-text-secondary">Account Status</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <Link
            to="/games"
            className="casino-bg-secondary backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 casino-border text-center group hover:border-yellow-400 transition-all duration-300"
          >
            ...
            <h3 className="text-base sm:text-lg font-semibold casino-text-primary mb-2">Play Games</h3>
          ...
          <Link
            to="/wallet"
            className="casino-bg-secondary backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 casino-border text-center group hover:border-green-400 transition-all duration-300"
          >
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-200" style={{ 
            ...
            <h3 className="text-base sm:text-lg font-semibold casino-text-primary mb-2">Manage Wallet</h3>
            <p className="casino-text-secondary text-xs sm:text-sm">
          ...
          <Link
            to="/profile"
            className="casino-bg-secondary backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 casino-border text-center group hover:border-purple-400 transition-all duration-300"
          >
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-200" style={{ 
              background: 'linear-gradient(135deg, #6A1B9A 0%, #00B0FF 100%)',
              boxShadow: '0 0 20px rgba(106, 27, 154, 0.3)'
            ...
            <h3 className="text-base sm:text-lg font-semibold casino-text-primary mb-2">Profile</h3>
            <p className="casino-text-secondary text-xs sm:text-sm">
          ...
          <Link
            to="/support"
            className="casino-bg-secondary backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 casino-border text-center group hover:border-blue-400 transition-all duration-300"
          >
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-200" style={{ 
            ...
            <h3 className="text-base sm:text-lg font-semibold casino-text-primary mb-2">Support</h3>
            <p className="casino-text-secondary text-xs sm:text-sm">
